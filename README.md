...
The example configs worth looking at are:
| CONFIG | DESCRIPTION | OPTIONS |
| --- | --- | --- |
| SAMPLER_CONFIG.method | Method to generate samples options with polygon | "convering_grid", "random", "gee_stratified", "centroid", "centroid_shift" |
