...
SAMPLER = {
    ...
    "training_ratio": 2e-1,  # ratio of training samples from total samples
    "test_ratio": 2e-3,  # ratio of test samples from total samples
...
DOWNLOADER = {
    ...
    "request_limit": 40,  # max number of parallel requests
