...
default:
	...
	echo
	echo "        sample:         Generates chip sample polygons using Google Earth Engine and provided shapefile at shapes/$(SUNDIAL_SAMPLE_NAME)."
	...
	echo "        index:          Creates indicies for training from chip and anno data using indexer in configs/$(SUNDIAL_EXPERIMENT_BASE_NAME)/sample.yaml."
	echo
