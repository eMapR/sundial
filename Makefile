...
default:
	...
	echo "        annotation:     Collects image annotations for experiment using sample polygons generated by sample method."
...
_annotation:
	$(eval export SUNDIAL_METHOD=annotation)
...
_run: _experiment_name_check
	if [[ "$(SUNDIAL_PROCESSING)" == hpc ]]; then \
		...
		python $(SUNDIAL_BASE_PATH)/sundial/runner.py; \
	fi;
