...
package: _experiment_name_check
	...
	tar -vzf $(HOME)/$(SUNDIAL_EXPERIMENT_NAME).tar.gz logs/$(SUNDIAL_EXPERIMENT_NAME); \
	tar -vzf $(HOME)/$(SUNDIAL_EXPERIMENT_NAME).tar.gz checkpoints/$(SUNDIAL_EXPERIMENT_NAME); \
	tar -vzf $(HOME)/$(SUNDIAL_EXPERIMENT_NAME).tar.gz predictions/$(SUNDIAL_EXPERIMENT_NAME); \
